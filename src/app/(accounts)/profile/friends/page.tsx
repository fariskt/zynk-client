      ...
      <div className="flex flex-col md:flex-row justify-between bg-white dark:bg-gray-900 dark:text-white items-center shadow-md border dark:border-0 py-4 px-6 rounded-md gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <input
            ...
            className=" rounded-md pl-3 border py-2 outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 focus:border-blue-500 transition w-full md:w-auto"
          />
