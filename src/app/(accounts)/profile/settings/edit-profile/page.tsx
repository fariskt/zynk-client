    ...
    <div className={editProfileMutation.isPending ? "animate-pulse" : ""}>
      ...
      <div className="flex items-center justify-between gap-4 my-5">
        <div className="flex items-center gap-4">
          ...
          <h3 className="border p-2 md:text-sm text-xs shadow-md border-gray-400 rounded">
      ...
      >
        <div className="grid grid-cols-2 gap-6">
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font-medium text-sm md:text-base">Fullname</label>
            <input
              type="text"
              className={`${
                isEditing ? "bg-gray-50 dark:bg-gray-700 border-gray-400" : "bg-gray-100 dark:bg-gray-800"
              } p-2 rounded-md border text-sm md:text-base border-gray-300 dark:border-gray-500 focus:ring focus:ring-blue-200 outline-none`}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font- text-sm md:text-base">Email</label>
            <input
              type="email"
              className="p-2 rounded-md bg-gray-100 border text-sm md:text-base border-gray-300 dark:border-gray-600  dark:bg-gray-800 outline-none cursor-not-allowed"
              placeholder="Email"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font-medium text-sm md:text-base">Birthday</label>
            <input
              type="date"
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
             className={`${
              isEditing ? "bg-gray-50 dark:bg-gray-700 border-gray-400" : "bg-gray-100 dark:bg-gray-800"
            } p-2 rounded-md border border-gray-300 text-sm md:text-base dark:border-gray-500 focus:ring focus:ring-blue-200 outline-none`}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font-medium text-sm md:text-base">Country</label>
            <input
              onChange={(e) =>
        ...
        <div className="mt-4">
          <label className="text-gray-600 font-medium text-sm md:text-base">Bio</label>
          <textarea
            value={formData.bio}
            name="bio"
            disabled={!isEditing}
            ...
            className={`${
              isEditing ? "bg-gray-50 dark:bg-gray-700 border-gray-400" : "bg-gray-100 dark:bg-gray-800"
            } w-full p-2 rounded-md  border text-sm md:text-base border-gray-300 dark:border-gray-500 focus:ring focus:ring-blue-200 outline-none resize-none h-24`}
