  ...
  return (
    <>
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={index}
          className="dark:bg-gray-900 dark:text-white mb-10 bg-white mt-0 shadow dark:border-0 border rounded-2xl py-1 max-w-4xl md:min-w-[700px] min-h-44 animate-pulse md:mx-0 mx-3"
        >
