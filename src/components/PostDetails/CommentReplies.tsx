  ...
  import { IoMdArrowDropdown, IoMdArrowDropright, IoMdHeart } from "react-icons/io";
  ...
  const CommentReply: React.FC<CommentReplyProps> = ({ reply, userID, comment , onReplyClick , toggleReplies, showReplies}) => {
        ...
        <div className="flex gap-4 items-start">
          ...
          <button
                    ...
                    >
                      ...
                      {showReplies[reply._id] ? <IoMdArrowDropdown /> : <IoMdArrowDropright />}
                    </button>
                  {/* )} */}
