      ...
      >
        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div
              className={`border-2 border-dashed md:h-56 rounded-lg flex flex-col items-center justify-center text-center p-6 cursor-pointer transition-all ${
            ...
            <div className="flex justify-between items-center">
              <div className="flex md:flex-row flex-col-reverse flex-wrap md:items-center gap-4 text-sm">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  className="dark:bg-gray-700 bg-gray-800 text-white dark:text-gray-200 px-4 py-2 rounded-lg text-sm hover:bg-gray-600"
                  onClick={onClose}
                >
                  Cancel
                </button>
                ...
                >
                  ...
                  ) : postData.isScheduled ? "Schedule" : "Post"}
                </button>
              </div>
            </div>
